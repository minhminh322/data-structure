...
public class ExpressionTree extends LinkedBinaryTree<ExpressionTreeOp> {
    ...
    public ExpressionTree(final ExpressionTreeOp theElement,
        ...
        super();
        myRoot = new BinaryTreeNode<ExpressionTreeOp>(theElement, theLeftSubtree,
                                                      theRightSubtree);
    }

    /**
     * Evaluates the expression tree by calling the recursive evaluateNode
     * method.
     *
     ...
     */
    private static int computeTerm(final char theOperator, final int theOperand1,
    ...
    /**
     * Generates a structured string version of the tree by performing a level
     * order traversal.
     *
    ...
    public String printTree() {
        ...
        final UnorderedListADT<Integer> levelList = new ArrayUnorderedList<Integer>();

...
public class ArrayStack<E> implements StackADT<E> {
     ...
     */
    private int mySize; // mySize also indicates the next available (open) array
                        // index

    /**
     * Initializes the stack. Initializes the backing array to a default size.
     */
    public ArrayStack() {

        /*
         * The warning here about type safety can be ignored. It is not possible
         * to instantiate a generic array, so this is the standard work around.
         */
    ...
    /**
     * Initializes the stack. Initializes the backing array to the specified
     * size.
     *
    ...
    public void push(final E theElement) {
        ...
        /*
         * Many software engineers recommend against embedding an increment in a
         * larger statement as done here. Instead the recommendation is to
         * improve the clarity of the code by doing this in two statements as
         * shown below.
         */
    ...
    public E pop() {
        ...
        mySize--;
        myElements[mySize] = null; // intentional null assignment - OK to ignore
                                   // the warning
    ...
    public String toString() {
        ...
        if (isEmpty()) {
            sb.append("Empty Stack"); // maybe an empty stack should return an
                                      // empty String?
        } else {
